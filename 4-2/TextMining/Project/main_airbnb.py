...
def case1(df_train):
    ...
    train_set, test_set = train_test_split(df_train, test_size=0.8, random_state=42, stratify=df_train["country_destination"])
    ...
    y_test = df_test["country_destination"].values
