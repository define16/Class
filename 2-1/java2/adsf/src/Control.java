...
public class Control extends JFrame implements ActionListener {
	...
	public Control()
	{
		...
		picpanel.add(piclabel); panel1.add(IDlabel); panel1.add(PWlabel); panel2.add(IDtxt);
		panel2.add(PWtxt);  panel3.add(joinbt); panel3.add(backbt); panel.add(picpanel);
		panel.add(empty); panel.add(panel1);  panel.add(panel2); panel.add(panel3);
		add(panel); setResizable(false); setVisible(true); 
	}
