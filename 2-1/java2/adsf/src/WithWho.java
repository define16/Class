...
public class WithWho extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      {		if (nametxt.getText().equals("")) {  JOptionPane.showMessageDialog(null, "이름을 입력하세요");   }  // 이름,나이,인원수중 하나라도 
           else if (agetxt.getText().equals("")) { JOptionPane.showMessageDialog(null, "나이을 입력하세요");  }// 작성을 안하면 메세지를 
           else if (populationtxt.getText().equals("")) {  JOptionPane.showMessageDialog(null, "인원수을 입력하세요");   } //띄워줍니다.
           else { try { 
