...
public class IconTest extends JFrame implements ActionListener{
  IconTest(String title){
    super(title);
    ...
    JButton b = new JButton("종료", new ImageIcon("Duke.gif"));
  ...
  public static void main(String args[]){
    IconTest f = new IconTest("IconTest");
    f.setSize(300, 300);
    f.setVisible(true);
  }
}
